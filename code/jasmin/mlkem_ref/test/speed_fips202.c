...
int main(void) {
  ...
  print_results("shake128_absorb34_c: ", t0, NRUNS);
  print_results("shake128_absorb34: ", t1, NRUNS);
  printf("------------------------------\n");
  ...
  print_results("shake128_squareblock__c: ", t0, NRUNS);
  print_results("shake128_squareblock_: ", t1, NRUNS);
  printf("------------------------------\n");
